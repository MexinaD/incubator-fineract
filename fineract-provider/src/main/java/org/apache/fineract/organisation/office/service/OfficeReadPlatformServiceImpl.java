    ...
    private static final class OfficeMapper implements RowMapper<OfficeData> {
        ...
        public String officeSchema() {
            return " o.id as id, o.name as name, "
                    ...
                    + " as nameDecorated, o.external_id as externalId, o.opening_date as openingDate, o.hierarchy as hierarchy, parent.id as parentId, parent.name as parentName, o.image_id as imageId "
        ...
        public OfficeData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return new OfficeData(id, name, nameDecorated, externalId, openingDate, hierarchy, parentId, parentName, imageId, null );
        }
    }
